...
test("operations admin can manage academic miniapp work but never approvals or renewals", async () => {
  ...
  assert.equal(canUseMiniappRenewalDesk(operationsUser), false);

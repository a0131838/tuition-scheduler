...
```text
Lesson focus / 本节课重点:
Hint / 提示: What learning problem did the student mainly work on today? / 孩子今天主要解决了什么学习问题？

Current finding / 目前发现:
Hint / 提示: What is the real learning bottleneck you observed? / 你观察到的真实学习卡点是什么？

Class performance / 课堂表现:
Hint / 提示: What visible progress, effort, accuracy, or difficulty appeared in class? / 课堂上有什么可观察的进步、投入度、正确率或困难？

Next plan / 下一步计划:
Hint / 提示: What will you train next, ideally with a time range or clear focus? / 接下来会训练什么，最好写清时间范围或重点方向。

What parents should know / 家长需要知道:
Hint / 提示: What should the parent understand so they do not misread the student's situation? / 家长应该如何理解孩子目前的状态，避免误判？
```

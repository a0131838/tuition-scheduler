...
- Current release line on this branch: `2026-04-11-r32` (scheduling coordination parent submissions now auto-advance to a match-aware ops follow-up state), intended for the next production deploy from this branch.

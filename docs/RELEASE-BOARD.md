...
- Current release line on this branch: `2026-06-04-r177` (school application rows now use a selectable school/application directory, and no-package students can proceed through a service billing case), intended for the next production deploy from this branch.

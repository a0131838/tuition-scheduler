...
- Current release line on this branch: `2026-06-02-r174` (renewal contracts now require an explicit invoice decision before sign-link preparation, linked/receipted invoices are protected from accidental deletion, and finance document views show contract-link source status), intended for the next production deploy from this branch.

...
- Current release line on this branch: `2026-07-23-r281` is live at runtime feature commit `a654dd1`; it adds a controlled package-course transition for future safe one-to-one lessons and standard 15/50/100-hour package suggestions.

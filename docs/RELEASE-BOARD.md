...
- Current release line on this branch: `2026-04-14-r53` (strict super-admin `zhao hongwei` can now directly correct approved parent receipts in place while preserving approvals and writing the correction into audit logs), intended for the next production deploy from this branch.

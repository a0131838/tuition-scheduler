...
- Current release line on this branch: `2026-06-04-r176` (school application service now has a dedicated admin entry page, sidebar shortcut, and first-screen student detail shortcut), intended for the next production deploy from this branch.

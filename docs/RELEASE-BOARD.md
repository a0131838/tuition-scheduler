...
- Current release line on this branch: `2026-04-16-r77` (student detail workbench density reset after the sticky shortcut cleanup), intended for the next production deploy from this branch.

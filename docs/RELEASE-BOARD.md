...
- Current release line on this branch: `2026-04-11-r29` (receipt drawer backdrop style neutralization), intended for the next production deploy from this branch.

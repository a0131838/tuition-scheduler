...
- Current release line on this branch: `2026-05-31-r164` (attendance pages now show an admin `Convert to Assessment` repair action for accidentally deducted assessment lessons), intended for the next production deploy from this branch.

...
- Current release line on this branch: `2026-05-31-r163` (attendance waive saves now reconcile historical auto-repair package transactions keyed by attendanceId), intended for the next production deploy from this branch.

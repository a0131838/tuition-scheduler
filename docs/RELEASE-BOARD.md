...
- Current release line on this branch: `2026-06-22-r197` (SSG v4 contract mode now uses a locked official Standard PEI-Student Contract v4.0 template source), intended for the next production deploy from this branch.

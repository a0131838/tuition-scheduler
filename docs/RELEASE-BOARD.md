...
- Current release line on this branch: `2026-06-04-r175` (school application service agreements now support parent sign links, dynamic 1-5 school fee lines, signed PDF export, and automatic parent invoice creation through the existing receipt workflow), intended for the next production deploy from this branch.

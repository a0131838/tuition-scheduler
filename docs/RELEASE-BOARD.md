...
- Current release line on this branch: `2026-06-05-r185` (school application agreement PDF labels are clearer and empty drafts no longer open a 500 PDF export error), intended for the next production deploy from this branch.

...
- Current release line on this branch: `2026-06-22-r196` (EduTrust readiness now includes student evidence records, C7 outcomes, evidence-pack checklist, and a guarded SSG v4 contract entry), intended for the next production deploy from this branch.

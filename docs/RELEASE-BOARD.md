...
- Current release line on this branch: `2026-04-14-r52` (finance can now backfill old parent payment-proof amounts inline and gets a final confirmation before creating a receipt whose amount diverges from invoice remaining balance or the selected proof), intended for the next production deploy from this branch.

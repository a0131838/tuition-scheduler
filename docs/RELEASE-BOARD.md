...
- Current release line on this branch: `2026-06-04-r178` (school application level entry now keeps school-facing grade wording plus an internal equivalent level, such as Year 13 as Grade 12 equivalent), intended for the next production deploy from this branch.

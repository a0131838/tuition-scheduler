...
- Current release line on this branch: `2026-07-12-r226` (official course-reminder template configuration, deploy-time template preservation, and explicit branch fetch), ready for production verification.

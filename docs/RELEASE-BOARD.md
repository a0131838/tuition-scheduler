...
- Current release line on this branch: `2026-06-18-r190` (manual invoice-gate exemptions now capture pre-approved scheduling exception approver, reason, optional minute limit, and follow-up due date at package creation), intended for the next production deploy from this branch.

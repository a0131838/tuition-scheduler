...
- Current release line on this branch: `2026-04-13-r50` (finance now gets a dedicated partial-receipt follow-up queue, invoice-progress CSV export, stronger create-form amount warnings, and more automatic next-receipt shortcuts), intended for the next production deploy from this branch.

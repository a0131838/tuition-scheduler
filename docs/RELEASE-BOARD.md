...
- Current release line on this branch: `2026-04-13-r51` (parent payment proofs can now store optional amounts, and finance sees real proof-vs-remaining comparison hints during receipt creation), intended for the next production deploy from this branch.

...
- Current release line on this branch: `2026-04-11-r30` (receipt drawer backdrop hover/focus color lock), intended for the next production deploy from this branch.

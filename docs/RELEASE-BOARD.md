...
- Current release line on this branch: `2026-06-22-r195` (EduTrust readiness now includes a default-safe SSG Standard PEI-Student Contract v4.0 mode foundation), intended for the next production deploy from this branch.

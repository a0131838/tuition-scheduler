...
export async function GET(req: Request) {
  ...
  const items = [
    ...
    { key: "renewals", title: "续费跟进", count: renewalOpen, target: "renewals", urgent: renewalUrgent > 0 || renewalOverdue > 0, definition: `博思及其他 ${renewalOpen - renewalXdf}，新东方 ${renewalXdf}；紧急 ${renewalUrgent}，到期 ${renewalOverdue}` },

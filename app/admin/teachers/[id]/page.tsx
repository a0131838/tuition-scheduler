      ...
      <div style={{ marginBottom: 16 }}>
        <TeacherCreateForm
          ...
          labels={{
            ...
            paymentProfileStatus: t(lang, "Finance Review Status", "财务核验状态"),
            paymentPendingReview: t(lang, "Pending Review", "待财务核验"),
            paymentVerified: t(lang, "Verified", "已核验"),
            paymentRejected: t(lang, "Rejected", "已退回"),
            paymentRejectReason: t(lang, "Reject reason", "退回原因"),
            ...
            wiseAccountName: t(lang, "Wise Account Holder Name", "Wise 户名"),
            wiseEmail: t(lang, "Wise Email", "Wise 邮箱"),
            wisePhone: t(lang, "Wise Phone", "Wise 手机号"),
            wiseTag: t(lang, "WiseTag / Wise Username", "WiseTag / Wise 用户名"),
            wiseCountry: t(lang, "Wise Country", "Wise 国家"),
            wiseCurrency: t(lang, "Wise Currency", "Wise 币种"),
            wiseNote: t(lang, "Wise Note", "Wise 备注"),
            legacyBankDetails: t(lang, "Legacy bank transfer details (read-only)", "历史银行转账资料（只读）"),
          ...
          initial={{
            ...
            teachingOnline: teacher.teachingOnline ?? false,
            teachingHome: teacher.teachingHome ?? false,
            paymentMethod: teacher.paymentMethod ?? "",
            paymentProfileStatus: teacher.paymentProfileStatus ?? "PENDING_REVIEW",
            paymentProfileRejectReason: teacher.paymentProfileRejectReason ?? "",
            payNowType: teacher.payNowType ?? "",
            payNowValue: teacher.payNowValue ?? "",
            payNowName: teacher.payNowName ?? "",
            payNowNote: teacher.payNowNote ?? "",
            wiseAccountName: teacher.wiseAccountName ?? "",
            wiseEmail: teacher.wiseEmail ?? "",
            wisePhone: teacher.wisePhone ?? "",
            wiseTag: teacher.wiseTag ?? "",
            wiseCountry: teacher.wiseCountry ?? "",
            wiseCurrency: teacher.wiseCurrency ?? "",
            wiseNote: teacher.wiseNote ?? "",
            bankName: teacher.bankName ?? "",
            bankAccountName: teacher.bankAccountName ?? "",
            bankAccountNumber: teacher.bankAccountNumber ?? "",
            bankBranchCode: teacher.bankBranchCode ?? "",
          }}
        />
      </div>

    ...
    <div>
      ...
      <AdminClassSessionsClient
        ...
        labels={{
          ...
          reschedule: t(lang, "Reschedule", "改时间"),
          rescheduleScope: t(lang, "Reschedule Scope", "改时间范围"),
          newStart: t(lang, "New Start", "新开始时间"),
          rescheduleDurationMin: t(lang, "New Duration (minutes)", "新时长(分钟)"),

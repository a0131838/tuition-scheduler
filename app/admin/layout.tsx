...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const adminNavGroups = [
    ...
    },
    {
      ...
      summary: t(lang, "Open the main student and teaching workflows from here first.", "学生、教学和交接的主操作入口都集中在这里。"),
      items: [
        {
          href: "/admin/students",
          label: t(lang, "Students", "学生"),
          description: t(lang, "Open intake, profiles, packages, and scheduling work.", "打开学生录入、档案、课包和排课入口。"),
          tone: "accent" as const,
        },
        {
          href: "/admin/enrollments",
          label: t(lang, "Enrollments", "报名"),
          description: t(lang, "Confirm class placement and active enrollment changes.", "处理报名分班和在读报名调整。"),
          tone: "success" as const,
        },
        {
          href: "/admin/packages",
          label: t(lang, "Packages", "课时包"),
          description: t(lang, "Handle balances, billing follow-up, and package edits.", "处理课包余额、账单跟进和课包编辑。"),
          tone: "success" as const,
        },
        {
          href: "/admin/tickets",
          label: t(lang, "Ticket Center", "工单中心"),
          description: t(lang, "Keep follow-ups, exceptions, and handoff work moving.", "跟进异常、待办和交接工单。"),
          tone: "warning" as const,
        },
        {
          href: "/admin/teachers",
          label: t(lang, "Teachers", "老师"),
          description: t(lang, "Manage teacher records, cards, and availability support.", "管理老师档案、老师名片和可上课时间支持。"),
          tone: "neutral" as const,
        },
        {
          href: "/admin/classes",
          label: t(lang, "Classes", "班级"),
          description: t(lang, "Open class rosters and recurring teaching groups.", "查看班级名单和固定教学班。"),
          tone: "neutral" as const,
        },
        {
          href: "/admin/booking-links",
          label: t(lang, "Booking Links", "学生选课链接"),
          description: t(lang, "Send and review self-booking intake flows.", "发送并跟进学生自助选课流程。"),
          tone: "neutral" as const,
        },
        {
          href: "/admin/feedbacks",
          label: t(lang, "Teacher Feedbacks", "老师课后反馈"),
          description: t(lang, "Review pending forwarding and missing feedback queues.", "查看待转发和缺失反馈队列。"),
          tone: "accent" as const,
        },
        {
          href: "/admin/tickets/handover",
          label: t(lang, "Daily Handover", "每日交接"),
          description: t(lang, "Check the day-end handoff list before leaving the queue.", "离开主队列前查看当日交接清单。"),
          tone: "warning" as const,
        },
        {
          href: "/admin/tickets/sop",
          label: t(lang, "SOP One Pager", "SOP一页纸"),
          description: t(lang, "Open the operating checklist for repeated workflows.", "打开重复流程的一页式操作指引。"),
          tone: "neutral" as const,
        },
      ],
    },

...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const adminNavGroups = [
    ...
    },
    {
      ...
      summary: t(lang, "People, scheduling, enrollment, and handoff work.", "人员、排课、报名和交接的核心操作。"),
      items: [
        { href: "/admin/teachers", label: t(lang, "Teachers", "老师"), tone: "neutral" as const },
        { href: "/admin/students", label: t(lang, "Students", "学生"), tone: "neutral" as const },
        { href: "/admin/classes", label: t(lang, "Classes", "班级"), tone: "neutral" as const },
        { href: "/admin/booking-links", label: t(lang, "Booking Links", "学生选课链接"), tone: "success" as const },

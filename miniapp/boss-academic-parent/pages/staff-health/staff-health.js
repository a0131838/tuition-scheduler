...
Page({
  ...
  open(e){const target=e.currentTarget.dataset.target;const map={operations:"/pages/staff-operations/staff-operations",requests:"/pages/staff-requests/staff-requests",communications:"/pages/staff-communications/staff-communications?kind=FEEDBACK", "communications-send":"/pages/staff-communications/staff-communications?kind=FEEDBACK&status=READY_TO_SEND",renewals:"/pages/staff-renewals/staff-renewals",schedule:"/pages/staff-schedule/staff-schedule",approvals:"/pages/staff-approvals/staff-approvals",leads:"/pages/staff-leads/staff-leads",reminders:"/pages/staff-reminder-attention/staff-reminder-attention"};wx.navigateTo({url:map[target]||"/pages/staff-action-center/staff-action-center"});}
});

...
export const schoolGuideSamplePacks: SchoolGuideSamplePack[] = [
  ["preschool-readiness-sample", "3-6岁入学观察与准备练习", "申请幼儿园、K1或K2的家庭", "20-30分钟", "博思原创练习"],
  ["primary-language-math-sample", "小学语言与数学准备练习", "准备小学入学测试的学生", "30分钟", "博思原创练习"],
  ...
  ["dsa-interview-sample", "DSA面试与活动证据练习", "准备DSA-Sec的学生", "30-45分钟", "博思原创练习"],
  ["jae-planning-checklist", "JAE志愿与材料核对清单", "申请JC、MI、Poly或ITE", "15分钟", "申请清单"],
  ["postsecondary-english-math-sample", "专上课程英文与数学准备练习", "申请PEI或衔接课程", "45分钟", "博思原创练习"],
  ["poly-eae-interview-sample", "Poly EAE作品与面试准备包", "准备Poly EAE申请", "30-45分钟", "博思原创练习"],
  ["ite-eae-interview-sample", "ITE EAE兴趣与面试准备包", "准备ITE EAE申请", "30分钟", "博思原创练习"],
  ["arts-portfolio-sample", "艺术作品集说明与面试练习", "申请LASALLE、NAFA或艺术路线", "45分钟", "博思原创练习"],
  ["university-application-checklist", "新加坡大学申请资料核对表", "使用A-Level、IB、Poly或国际资格申请本科", "20分钟", "申请清单"],
  ["sped-parent-observation-checklist", "SPED申请家长观察与报告清单", "准备专业评估或SPED申请的家庭", "20分钟", "申请清单"],
...
const baseEnhancements: Record<string, Pick<SchoolGuideDetailedPathway, "steps" | "examSections" | "documents" | "samplePackSlugs">> = {
  "moe-p1-international": {
    ...
    samplePackSlugs: ["preschool-readiness-sample"],
  },
  "aeis-primary": {
...
const extraPathways: SchoolGuideDetailedPathway[] = [
  {
    ...
    examSections: [{ title: "选拔", detail: "没有统一题型；按学校人才领域进行面试、试演、作品审查、技能任务或其他选拔。" }], documents: ["活动与比赛记录", "作品集或表演资料", "学校成绩与教师意见", "学生对专长的反思与持续投入证据"], samplePackSlugs: ["dsa-interview-sample"],
  },
  {

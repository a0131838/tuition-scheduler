...
export const schoolGuideDirectoryCategories: SchoolGuideDirectoryCategory[] = [
  ...
  { id: "postsecondary", title: "公立高中、Poly与大学", subtitle: "每所Poly和自治大学独立介绍，BCA单独归类", sectorIds: ["jc-mi", "ite-poly-arts", "autonomous-universities"], groups: [{ id: "ALL", title: "全部" }, { id: "jc-mi", title: "JC / MI" }, { id: "polytechnics", title: "五所Poly" }, { id: "bca-academy", title: "BCA Academy" }, { id: "research-universities", title: "综合/研究型大学" }, { id: "applied-universities", title: "应用/设计型大学" }, { id: "ite", title: "ITE" }, { id: "arts", title: "艺术院校" }] },
